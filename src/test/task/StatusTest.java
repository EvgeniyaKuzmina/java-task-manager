...
class StatusTest {
    ...
    void shouldReturnStatusNewForEpicIfAllSubTasksNew() {
        ...
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.NEW);
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksNewDone() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.DONE);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.NEW);
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksInProgress() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.IN_PROGRESS);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.IN_PROGRESS);
        assertEquals(Status.IN_PROGRESS,Status.getStatusForEpic(List.of(subtask, subtask1)));
    }
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksInProgressNewDone() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.NEW);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.IN_PROGRESS);
        SubTask subtask2 = new SubTask(1L, 5L, "Подзадача 2", "описание подзадачи", Status.DONE);
