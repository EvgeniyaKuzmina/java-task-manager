...
class SubTaskTest {
    ...
    void shouldReturnEpicId() {
        subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.NEW, 2023, 3, 25, 15);
    ...
    void ShouldReturnSubTaskFromString() {
        subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.NEW, 2023, 3, 25, 15);
        assertEquals(subtask, SubTask.fromString("3,SUBTASK,Подзадача 1,NEW,описание подзадачи,25.3.2023,15,1"));
    }
}