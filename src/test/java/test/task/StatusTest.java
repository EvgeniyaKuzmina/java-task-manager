...
class StatusTest {
    ...
    void shouldReturnStatusNewForEpicIfAllSubTasksNew() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.NEW, 2022, 3,25,15);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.NEW, 2022, 3,25,15);
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksNewDone() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.DONE, 2022, 3,25,15);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.NEW, 2022, 3,25,15);
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksInProgress() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.IN_PROGRESS, 2022, 3,25,15);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.IN_PROGRESS, 2022, 3,25,15);
        assertEquals(Status.IN_PROGRESS,Status.getStatusForEpic(List.of(subtask, subtask1)));
    }
    ...
    void shouldReturnStatusInProgressForEpicIfSubTasksInProgressNewDone() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.NEW, 2022, 3,25,15);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.IN_PROGRESS, 2022, 3,25,15);
        SubTask subtask2 = new SubTask(1L, 5L, "Подзадача 2", "описание подзадачи", Status.DONE, 2022, 3,25,15);
    ...
    void shouldReturnStatusDoneForEpicIfSubTasksDone() {
        SubTask subtask = new SubTask(1L, 3L, "Подзадача 1", "описание подзадачи", Status.DONE, 2022, 3,25,15);
        SubTask subtask1 = new SubTask(1L, 4L, "Подзадача 2", "описание подзадачи", Status.DONE, 2022, 3,25,15);
        SubTask subtask2 = new SubTask(1L, 5L, "Подзадача 2", "описание подзадачи", Status.DONE, 2022, 3,25,15);
